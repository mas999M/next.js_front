...
export default function Product()
{
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('sendCategory', sendCategory);
            ...
            <div className="bg-white border rounded-lg p-8 mx-auto my-8 max-w-lg shadow shadow-2xl">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <label htmlFor="gender" className="block text-gray-700 font-medium mb-2">Category</label>

                        <select id="gender" name="gender" onChange={handleCategory}
                                className="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400"
                                required value={sendCategory}>
                    ...
                    {/*image*/}
                    <div className="mb-4 text-center">Image</div>
                    <div className="w-full py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed ">
                        <div className="grid gap-1">
                            ...
                            <h2 className="text-center text-gray-400   text-xs leading-4">PNG, JPG or PDF, smaller than
                                15MB</h2>
                        </div>
                        <div className="grid gap-2">
                            <h4 className="text-center text-gray-900 text-sm font-medium leading-snug"> Product Image</h4>
                    ...
                    <div className="mb-4">
                        <label htmlFor="message" className="block text-gray-700 font-medium mb-2">Description</label>
                        <textarea id="message" name="message"
                                  className="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400"
                                  rows="5" onChange={(e) => setDescription(e.target.value)} value={description}></textarea>
                    </div>

                    <div>
                        <button type="submit"
                                className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Submit
                        </button>
                    </div>
