...
import {useUpdate} from "./product-context";
                    ...
                    <Table>
                        ...
                        <TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            {tableData.map((order , index) => {
                                // console.log('idididiidididdidi',order.id);
                                return(

                                    <TableRow
                                        key={index}
                                        onClick={() => router.push(`update-post/${order.id}`)}
                                    ...
                                    >
                                        ...
                                        <TableCell className="py-3 px-4 text-gray-600 text-theme-sm dark:text-gray-400">
